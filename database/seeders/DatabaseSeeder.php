...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Mentor::create([
          ...
          'password' => bcrypt('password'),
          'deskripsiMentor' => 
          'Ahmad is Professional Trainer teach about Computer Networking & Python Programming. Have experience more than 5 years, make him credible to teach about Computer Networking especially Cisco & Mikrotik. Ahmad also work as Network Engineer, doing some project in many big company to handle their network infrastructure. Ahmad use his python skill to manage thousands of networking devices, so many company choose him to manage their big network infrastructure. Ahmad also work as Software Defined Networking (SDN) Developer, Build SDN Application using Django & Flask.',
          'isAdmin' => '0',
      ]);
        ...
        Mentor::create([
            ...
            'password' => bcrypt('password'),
            'deskripsiMentor' => 
            "Sebagai lembaga dibidang pelatihan dan konsultasi kami berkomitmen untuk meningkatkan kualitas SDM dan pengembangan organisasi di perusahaan-perusahaan klien kami. Salah satu alat dan modal utama untuk mencapai visi dan misi perusahaan adalah sumber daya manusia (SDM) yang dimiliki yaitu SDM yang mampu menjalankan peran dan fungsinya dengan baik dan benar. SDM merupakan satu-satunya aset yang independen dan dinamis sehingga SDM dapat menjadi aset yang potensial hanya jika dikelola dan dikembangkan dengan cara yang baik. Bale training merupakan institusi yang concern menerapkan pengetahuan “Rahasia Positive Thinking & Positive Feeling” yang mampu merubah SDM perusahaan. Dengan perpaduan dua “Rahasia” tersebut dapat membantu meningkatkan percepatan Kompetensi SDM perusahaan. Skala prioritas Bale Training adalah untuk meningkatkan kinerja SDM melalui program pelatihan yang sesuai dengan kebutuhan karyawan, sistematis dan berkesinambungan. Bale Training juga membantu perusahaan mempersiapkan riset-riset manajemen yang aplicable melalui metodologi yang tepat. Jasa pelatihan kami telah banyak membantu perusahaan-perusahaan dan instansi pemerintahan dalam peningkatan kualitas SDM-nya dan meningkatkan daya saing dalam menghadapi tantangan Global.",
            'isAdmin' => '0',
        ]);
        ...
        Mentor::create([
            ...
            'password' => bcrypt('password'),
            'deskripsiMentor' => 
            "Christian F. Guswai, adalah Konsultan, Trainer, Author, dan Pembicara Publik di bisnis retail yang telah berpengalaman lebih dari 32 tahun di industri ritel. Penerima award: 100 Top Global Training and Development Minds di Kongres Sumber Daya Manusia Dunia di Mumbai, India. Dan pada tahun 2019 mendapatkan award sebagai Top Global Retail Minds di Asia Africa GCC Retail Congress. 15 tahun pertamanya dijalani sebagai praktisi bisnis ritel di mana Guswai bersentuhan dengan multi-format ritel seperti; department store (Cahaya Department Stores), perusahaan grosir multinasional (Makro Cash & Carry), Hypermarket (Continent Hypermarket dan Carrefour Indonesia). 17 tahun berikutnya, pengalamannya sebagai konsultan bagi banyak peritel di seluruh Indonesia, mulai dari ujung barat hingga bagian timur Indonesia, telah memperkaya pengalamannya dalam menangani berbagai jenis permasalahan di bisnis ritel. Guswai juga berbagi ilmu bisnis ritel baik melalui workshop/training umum maupun pelatihan bagi banyak perusahaan ritel nasional untuk berbagai topik bisnis ritel. Dengan pengalaman dan pengetahuannya yang teruji, Guswai telah menulis 9 buku dalam rangkaian Retail Excellence Series dan telah menjadi buku panduan wajib bagi peritel di seluruh negeri. Selain itu Guswai juga menjadi kontributor sebagai kolumnis dan nara sumber untuk beberapa media baik cetak maupun elektronik. Guswai kerap diundang sebagai pembicara di beberapa forum internasional.",
            'isAdmin' => '0',
        ]);
        ...
        Mentor::create([
            ...
            'password' => bcrypt('password'),
            'deskripsiMentor' => 
            "Established Jakarta telah membantu banyak mitra untuk terhubung dengan konsumen untuk menmberikan dampak positif bagi bisnis mereka. Kami terus belajar untuk meningkatkan pengetahuan dan keahlian kami untuk menciptakan solusi pemasaran yang sesuai dengan kebutuhan bisnis mitra kami. Kami juga memiliki misi untuk memasyarakatkan ilmu digital marketing dan teknologi ke dalam kehidupan setiap orang untuk bisnis dan masyarakat yang lebih baik. Dan sekarang, giliran Anda untuk menyelam lebih dalam dan meningkatkan keterampilan digital Anda",
            'isAdmin' => '0',
        ]);
        ...
        Mentor::create([
            ...
            'password' => bcrypt('password'),
            'deskripsiMentor' => 
            'Saya adalah seorang scientist sekaligus dosen yang ekspert di matematika. Saya tertarik ilmu musik dan mendalami penggunaan software fl studio 20. ALhamdulillah saya berhasil menguasainya, adapun lagu-lagu yang berhasil saya remix menggunakan fl studio meliputi genre Pop, house trance, dan MIDI. Saya tidak mempunyai pengalaman khusus terkait musik, saya tidak bisa main gitar, tidak bisa main piano, maupun alat musik lain. Saya hanya seorang penikmat musik. Saya senang mendengarkan berbagai macam genre musik dari musik jadul sampai musik terkini. Di era revolusi industri 5.0 ini, segala macam aspek mulai banyak terintegrasi dengan kecanggihan teknologi. Termasuk dunia musik. Anda bisa bikin lagu sebagaimana band professional hanya dengan modal laptop dan duduk manis di depan meja kerja anda. Tetapi untuk mewujudkan itu, anda wajib menguasai salah satu software pembuat musik. FL STUDIO adalah yang paling recomended karena tampilannya lebih sederhana, lebih mudah diaplikaskan dan sudah digunakan oleh banyak DJ berkelas dunia seperti Martin Garrix. Untuk itulah saya disini mecoba membantu mewujudkan impian anda dengan membuka kursus ini.',
            'isAdmin' => '0',
        ]);
        ...
        Course::create([
            ...
            'deskripsiCourse' => 
            'Microsoft Excel adalah sebuah aplikasi yang sering digunakan sehari-hari bagi para pekerja, pengusaha, maupun mahasiswa yang sangat membantu dalam proses mengolah dan menganalisis data sesuai dengan kebutuhan. Bentuknya yang di desain dalam spreadsheet yang dibuat serta didistribusikan oleh Microsoft Corporation agar dapat digunakan untuk sistem operasi Windows dan juga Mac OS. Di era digital saat ini, belajar keterampilan mengoperasikan Microsoft Excel bukan lagi menjadi suatu kebutuhan, namun keharusan yang perlu dikuasai. Banyak bidang yang relevan sekali dalam penggunakan aplikasi ini dan tentunya digunakan untuk mempermudah proses kerja. Microsoft Excel sangat membantu dalam meningkatkan produktivitas kerja dengan catatan Sobat QuBisa dapat mahir dalam penggunaan rumus excel atau fitur function dan formulas-nya. Yuk, pelajari kursus ini dan tingkatkan keterampilanmu dalam mengolah dan menganalisis data dengan menggunakan Microsoft Excel. Selamat belajar!',
        ...
        Course::create([
            ...
            'deskripsiCourse' => 
            'Semua orang pasti memiliki keinginan yang berkaitan dengan uang seperti membeli barang-barang baru, memiliki dana untuk melanjutkan pendidikan, atau mempunyai tabungan pensiun. Banyak yang menyerah untuk mendapatkannya padahal sebenarnya semua keinginan tersebut mungkin untuk dimiliki. Salah satu caranya adalah memahami konsep dasar pengelolaan keuangan, pondasi dalam menggunakan uang dengan lebih bijak, efektif, dan efisien. Pada program ini, kita akan belajar pengetahuan dan keterampilan pengelolaan keuangan dasar mulai dari menetapkan tujuan, perencanaan, mencoba simulasi hingga tips praktis yang akan membantu dalam mengelola keuangan. Yuk latih keterampilan mengelola uang untuk menunjang kehidupan yang lebih terencana dan terstruktur secara finansial!',
       ...
       Course::create([
        ...
        Course::create([
            ...
            'deskripsiCourse' => 
            'Indonesia sebagai salah satu negara dengan jumlah penduduk terbesar di dunia tentu menjadi salah satu negara dengan jumlah pengguna media sosial terbesar di dunia. Sebagai contoh, Indonesia menduduki peringkat ketiga sebagai negara dengan jumlah pengguna Facebook dengan 130 juta pengguna aktif bulanan. Selain itu Indonesia juga memiliki 62 juta pengguna aktif bulanan di Instagram, yang merupakan jumlah terbesar ke-4 didunia untuk pengguna Instagram aktif. Tentu perusahaan tidak ingin melewatkan kesempatan ini.  Maka tidak heran jika saat ini banyak pemilik bisnis mencari seorang Digital Marketing yang mampu menunjang tujuan dari peningkatan penjualan bisnis mereka.',
