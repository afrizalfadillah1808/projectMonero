    ...
    <div class="container m-0 px-0">
      <div class="m-0 row">
        <div class="col-10 ms-5 p-0">
          <button class="border-0 bg-indigo-600 px-4 py-2 fw-medium rounded-2 text-center" style="width: auto;"><a class="text-indigo-100" href="/dashboard/discounts/create" style="text-decoration: none;">Add Discount</a></button>
        </div>
      </div>
    </div>
