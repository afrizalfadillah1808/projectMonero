              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="d-flex justify-content-center gap-2 align-middle">
                    <a href="/dashboard/discounts/{{ $discount->id }}/edit" class="bg-indigo-600 py-1 px-2 rounded-2" style="width: 32px; height: 32px;"><i class="fa-solid fa-wrench text-indigo-100"></i></a>
                    <a href="/dashboard/discounts/{{ $discount->id }}" class="bg-indigo-600 py-1 px-2 rounded-2" style="width: 32px; height: 32px;"><i class="fa-solid fa-eye text-indigo-100"></i></a>
