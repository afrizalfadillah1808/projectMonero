  ...
  <div class="m-0 col-auto col-md-9 col-xl-10 px-sm-2 pt-5">
    ...
    <form action="/dashboard/categories/{{ $category->slugCategory }}" method="POST" class="ms-5 col-md-5 pt-2" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <button type="submit" class="bg-indigo-600 px-4 py-2 fw-medium rounded-2 text-center text-indigo-100 text-decoration-none border-0" style="text-decoration: none; width: auto;">Edit Category</button>
      </div>
    </form>
  </div>
@endsection