  ...
  <div class="m-0 col-auto col-md-9 col-xl-10 px-sm-2 pt-5">
    ...
    <div class="class-details d-flex flex-column text-indigo-900 mx-5 col-9">
      ...
      <div class="d-flex gap-1">
        ...
        <button class="border-0 bg-indigo-600 px-4 py-2 fw-medium rounded-2 text-center" style="width: auto;"><a class="text-indigo-100" href="/dashboard/admin/courses/{{ $course->slugCourse }}/edit" style="text-decoration: none;">Edit</a></button>
