  ...
  <div class="login-content d-flex flex-column align-items-center mx-auto p-5" style="width: 35%">
    ...
    <div class="form-login-content w-100">
      <form action="/login" method="POST">
        @csrf
        <div class="mb-3">
          <input type="text" class="@error('username') is-invalid @enderror border-0 bg-indigo-115 rounded-xl p-3 w-100 text-indigo-900" id="username" name="username" placeholder="Username" value="{{ old('username') }}" autofocus required>
          @error('username')
